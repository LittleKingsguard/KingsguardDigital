  ...
  "node_modules/react-dom/cjs/react-dom-client.development.js"(exports) {
    ...
    (function() {
      ...
      function getFallbackBeforeInputChars(domEventName, nativeEvent) {
        if (isComposing)
          return "compositionend" === domEventName || !canUseCompositionEvent && isFallbackCompositionEnd(domEventName, nativeEvent) ? (domEventName = getData2(), fallbackText = startText = root2 = null, isComposing = false, domEventName) : null;
        switch (domEventName) {
          case "paste":
            return null;
          case "keypress":
      ...
      function dispatchEventForPluginEventSystem(domEventName, eventSystemFlags, nativeEvent, targetInst$jscomp$0, targetContainer) {
        ...
        batchedUpdates$1(function() {
          ...
          if (0 === (eventSystemFlags & 7)) {
            ...
            eventType && (useFallbackCompositionData && "ko" !== nativeEvent.locale && (isComposing || "onCompositionStart" !== eventType ? "onCompositionEnd" === eventType && isComposing && (fallbackData = getData2()) : (root2 = nativeEventTarget, startText = "value" in root2 ? root2.value : root2.textContent, isComposing = true)), handleEventFunc = accumulateTwoPhaseListeners(
              targetInst,
              eventType
...
// public/javascripts/Renderers/ContentRenderer.js
var import_react10 = __toESM(require_react());

// public/javascripts/Contexts.js
var import_react = __toESM(require_react());
var contentDispatchContext = (0, import_react.createContext)(null);
var locationContext = (0, import_react.createContext)([]);
var dataContext = (0, import_react.createContext)({});

// public/javascripts/Renderers/ContentRenderer.js
var import_react11 = __toESM(require_react());

// public/javascripts/Actions/ActionsHelpers.js
...
function loadDispatch(data, dispatch) {
  dispatch({
    type: "load",
    content: data
  });
...
async function login(username, password, location, dispatch) {
...
async function register(username, email, password, location, dispatch) {
...
async function logout(location, dispatch) {
...
// public/javascripts/Renderers/RenderHelpers.js
function validateId(css) {
...
// public/javascripts/Renderers/StructureContentRenders.js
var import_react6 = __toESM(require_react());

// public/javascripts/Renderers/InlineContentRenders.js
var import_react4 = __toESM(require_react());

// public/javascripts/Renderers/TextContentRenders.js
var import_react2 = __toESM(require_react());
function buildP(data) {
  if (!validateTextElement("p", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("p", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildH1(data) {
  if (!validateTextElement("h1", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("h1", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildH2(data) {
  if (!validateTextElement("h2", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("h2", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildH3(data) {
  if (!validateTextElement("h3", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("h3", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildH4(data) {
  if (!validateTextElement("h4", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("h4", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildH5(data) {
  if (!validateTextElement("h5", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("h5", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildH6(data) {
  if (!validateTextElement("h6", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("h6", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildLi(data) {
  if (!validateTextElement("li", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("li", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildTh(data) {
  if (!validateTextElement("th", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react2.default.createElement("th", { ...data.props, id, className: classnames }, addElements(data.content));
}
function buildTd(data) {
  if (!validateTextElement("td", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
...
// public/javascripts/Renderers/MediaContentRenders.js
var import_react3 = __toESM(require_react());
function buildImg(data) {
  if (!validateMediaElement("img", data) || data.props.width < 0 || data.props.height < 0 || typeof data.props.src !== "string" || typeof data.props.alt !== "string") {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react3.default.createElement("img", { className: classnames, id, ...data.props });
}
function buildVideo(data) {
  if (!validateMediaElement("video", data) || data.props.width < 0 || data.props.height < 0 || typeof data.props.src !== "string") {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react3.default.createElement("video", { className: classnames, id, ...data.props });
}
function buildCanvas(data) {
  if (!validateMediaElement("canvas", data) || data.props.width < 0 || data.props.height < 0) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react3.default.createElement("canvas", { className: classnames, id, ...data.props });
}
function buildSVG(data) {
  if (!validateMediaElement("svg", data) || data.props.width < 0 || data.props.height < 0 || typeof data.props.vectors !== "string") {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react3.default.createElement("svg", { className: classnames, id, ...data.props }, data.props.vectors);
}
function mediaRenderer(data) {
  switch (data.type) {
    case "img":
...
function addEmphasis(data) {
  ...
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react4.default.createElement("em", { ...data.props, id, className: classnames }, addElements(data.content));
}
function addStrong(data) {
  if (!validateInlineContents("strong", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react4.default.createElement("strong", { ...data.props, id, className: classnames }, addElements(data.content));
}
function addCite(data) {
  if (!validateInlineContents("cite", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react4.default.createElement("cite", { ...data.props, id, className: classnames }, addElements(data.content));
}
function addMark(data) {
  if (!validateInlineContents("mark", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react4.default.createElement("mark", { ...data.props, id, className: classnames }, addElements(data.content));
}
function addDfn(data) {
  if (!validateInlineContents("dfn", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react4.default.createElement("dfn", { ...data.props, id, className: classnames, title: data.props.title }, addElements(data.content));
}
...
function buildDiv(data) {
  if (!validateStructureElement("div", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react6.default.createElement("div", { ...data.props, className: classnames, id }, addElements(data.content));
}
function buildUnorderedList(data) {
  if (!validateStructureElement("ul", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react6.default.createElement("ul", { ...data.props, className: classnames, id }, addElements(data.content));
}
function buildAnchor(data) {
  console.log(data.content);
  if (!validateStructureElement("a", data) || typeof data.props.url !== "string") {
    console.log("Failed creating anchor:" + JSON.stringify(data));
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react6.default.createElement("a", { ...data.props, className: classnames, id }, addElements(data.content));
}
function buildTitle(data) {
  if (data.type !== "title" || typeof data.content !== "string") {
    return;
  }
  return /* @__PURE__ */ import_react6.default.createElement("title", { ...data.props }, data.content);
}
function structureRenderer(data) {
  switch (data.type) {
    case "a":
...
// public/javascripts/Renderers/FormContentRenders.js
var import_react7 = __toESM(require_react());
function buildForm(data) {
  if (!validateStructureElement("form", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("form", { ...data.props, className: classnames, id }, addElements(data.content));
}
function buildFieldset(data) {
  if (!validateStructureElement("fieldset", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("fieldset", { ...data.props, className: classnames, id }, addElements(data.content));
}
function buildSelect(data) {
  if (!validateStructureElement("select", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("select", { ...data.props, className: classnames, id }, addElements(data.content));
}
function buildOption(data) {
  if (!validateTextElement("option", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("option", { ...data.props, className: classnames, id }, data.content);
}
function buildDatalist(data) {
  if (!validateStructureElement("datalist", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("datalist", { ...data.props, className: classnames, id }, addElements(data.content));
}
function buildOptgroup(data) {
  if (!validateStructureElement("optgroup", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("optgroup", { ...data.props, className: classnames, id }, addElements(data.content));
}
function buildInput(data) {
  ...
  if (!validateEmptyElement("input", data) && !validInputs.includes(data.props.type)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("input", { ...data.props, className: classnames, id });
}
function buildOutput(data) {
  if (!validateEmptyElement("output", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("output", { ...data.props, className: classnames, id });
}
function buildLabel(data) {
  if (!validateText("label", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("label", { ...data.props, className: classnames, id }, data.content);
}
function buildLegend(data) {
  if (!validateTextElement("legend", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("legend", { ...data.props, className: classnames, id }, data.content);
}
function buildTextarea(data) {
  if (!validateText("textarea", data) || data.props.width < 0 || data.props.height < 0) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("textarea", { ...data.props, className: classnames, id }, data.content);
}
function buildButton(data) {
  if (!validateText("button", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  return /* @__PURE__ */ import_react7.default.createElement("button", { ...data.props, className: classnames, id }, data.content);
}
function formRenderer(data) {
  switch (data.type) {
    case "button":
...
// public/javascripts/Renderers/BespokeRenders.js
var import_react8 = __toESM(require_react());
var import_react9 = __toESM(require_react());
function buildLogin(data) {
  console.log("Login ran");
  console.log(data);
  if (!validateEmptyElement("login", data)) {
    return;
  }
  let id = validateId(data.css);
  let classnames = classlist(data.css);
  const location = (0, import_react9.useContext)(locationContext);
  const dispatch = (0, import_react9.useContext)(contentDispatchContext);
  let onclickHandler = () => {
  ...
  return /* @__PURE__ */ import_react8.default.createElement("div", { ...data.props, className: classnames, id }, /* @__PURE__ */ import_react8.default.createElement("div", null, /* @__PURE__ */ import_react8.default.createElement("form", null, /* @__PURE__ */ import_react8.default.createElement("label", null, "Username:"), /* @__PURE__ */ import_react8.default.createElement("input", { id: "username", type: "text", name: "username", placeholder: "Username" }), /* @__PURE__ */ import_react8.default.createElement("label", null, "Password:"), /* @__PURE__ */ import_react8.default.createElement("input", { id: "password", type: "password", name: "password", placeholder: "Password" }), /* @__PURE__ */ import_react8.default.createElement("button", { id: "loginButton", type: "button", onClick: onclickHandler }, "Log In"))), /* @__PURE__ */ import_react8.default.createElement("div", null, /* @__PURE__ */ import_react8.default.createElement("form", null, /* @__PURE__ */ import_react8.default.createElement("label", null, "Username:"), /* @__PURE__ */ import_react8.default.createElement("input", { id: "registerUsername", type: "text", name: "username", placeholder: "Username" }), /* @__PURE__ */ import_react8.default.createElement("label", null, "Password:"), /* @__PURE__ */ import_react8.default.createElement("input", { id: "registerPassword", type: "password", name: "password", placeholder: "Password" }), /* @__PURE__ */ import_react8.default.createElement("label", null, "Email:"), /* @__PURE__ */ import_react8.default.createElement("input", { id: "registerEmail", type: "email", name: "email", placeholder: "person@example.com" }), /* @__PURE__ */ import_react8.default.createElement("button", { id: "registerButton", type: "button", onClick: onclickRegister }, "Register"))));
}
function userPane(data) {
  console.log("userPane ran");
  console.log(data);
  if (!validateStructureElement("userPane", data)) {
    return;
  }
...
function BuildElements() {
  ...
  if (newElement === void 0) newElement = inlineRenderer(data);
  if (newElement === void 0) newElement = mediaRenderer(data);
  if (newElement === void 0) newElement = formRenderer(data);
  if (newElement === void 0) newElement = bespokeRenderer(data);
  return newElement;
}
...
// public/javascripts/GetContent.js
...
root.render(/* @__PURE__ */ import_react14.default.createElement(Content.DisplayContent, null));
window.getContent = getData;
